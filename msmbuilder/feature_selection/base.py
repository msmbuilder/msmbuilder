...
class MultiSequenceFeatureSelectionMixin(BaseEstimator):
    # The API for the scikit-learn feature_selection object is, in fit(), that
    ...
    def transform(self, sequences):
        """Apply feature selection to sequences
        Parameters
        ----------
    ...
    def fit_transform(self, sequences, y=None):
        """Fit the model and apply feature selection
        Parameters
        ----------
        sequences: list of array-like, each of shape (n_samples_i, n_features)
