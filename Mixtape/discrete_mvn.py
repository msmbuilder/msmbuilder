...
def discrete_approx_mvn(X, means, covars):
    ...
    The method employs find the discrete distribution with minimal K-L
    divergence to the target distribution under the constraints that the
    mean and variance of the two distributions match exactly.
